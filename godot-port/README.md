...
> **This is the original Godot implementation.** See the [game overview](../README.md),
> the from-scratch [raylib 6 / C port](../raylib-port/), or the measured
> [engine comparison](../GODOT_VS_RAYLIB.md).
